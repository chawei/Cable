...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    else if (buttonStyle == CBActionSheetButtonStyleYellow) {
      font = [UIFont fontWithName:@"ProximaNova-Regular" size:15.0f];
      titleColor = [UIColor whiteColor];
      
      backgroundColor = rgb(253.0f, 195.0f, 0.0f);
      borderColor = rgb(253.0f, 195.0f, 0.0f);
    }
